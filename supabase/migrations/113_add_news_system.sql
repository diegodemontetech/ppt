...
-- Add news access to user_groups
ALTER TABLE user_groups
ADD COLUMN IF NOT EXISTS news_access BOOLEAN DEFAULT false;
...
INSERT INTO news_categories (name, description) VALUES
    ...
    (' <boltAction type="file" filePath="supabase/migrations/113_add_news_system.sql">
    'Treinamentos', 'Novos treinamentos e cursos'),
    ('Comunicados', 'Comunicados importantes'),
    ('Tecnologia', 'Notícias sobre tecnologia e inovação')
