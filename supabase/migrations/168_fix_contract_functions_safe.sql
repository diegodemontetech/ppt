-- Fix contract functions with safe checks
BEGIN;
...
BEGIN
    ...
    -- Drop functions
    DROP FUNCTION IF EXISTS can_access_contract;
    DROP FUNCTION IF EXISTS handle_contract_status;
    DROP FUNCTION IF EXISTS handle_contract_signature;
END $$;
