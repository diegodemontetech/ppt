...
import { Play, Book, Users, Star, Clock } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          {module.video_url ? (
            <div className="aspect-w-16 aspect-h-9">
              <VideoPlayer videoUrl={module.video_url} title={module.title} />
            </div>
          ) : (
          ...
          <div className="p-8">
            ...
            <div className="mt-8 grid grid-cols-4 gap-6">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-600">
                  {formatDuration(module.lessons?.reduce((acc, lesson) => acc + (lesson.duration || 0), 0) || 0)}
                </span>
              </div>
            </div>
